...
- Task: `Rebind existing SF5 framework contract registry change to exact Skill Sync evidence`
- Objects: 9
- Relations: 20
...
- `capability.sf5.page-recipes` (0.36): Route work to page recipes and scenario playbooks for landing, dashboard, catalog, auth, checkout and profile flows.
