...
- Task: `Make SF5 checks portable in clean CI checkout while preserving full upstream validation`
- Objects: 9
- Relations: 20
...
- `skill.sf5.core` (0.33): Owns SIMAI Framework 5 frontend-first workflows: loader, utilities, components, smart-components, recipes and staged backend planning.
...
- `capability.sf5.frontend-components` (0.18): Implement SF5 frontend components, blocks, utilities, modifiers and component recipes.
- `capability.sf5.loader-runtime` (0.18): Handle frontend loader, smart runtime, backend-first integration and project conventions.
