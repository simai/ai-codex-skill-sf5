...
- Task: `Sync current framework source inventories after ui-utilities retirement`
- Objects: 9
- Relations: 20
...
- `capability.sf5.tailwind-conversion` (0.18): Convert Tailwind/UI source into SF5 components with working-set coverage and validation hardening.
- `policy.sf5.frontend-first-boundary` (0.15): Keep SF5 frontend-first scope explicit and escalate staged backend work to the owning platform skill.
