...
- Task: `Publish Simai Framework portable Smart artifact ABI v1 ownership and host adapter boundaries`
- Objects: 9
- Relations: 20
...
- `gate.sf5.release-readiness` (0.33): Blocks completion until component/loader changes have working-set, validation and release-gate evidence.
