...
- Task: `Remove path-dependent SF5 inventory output and preserve clean-checkout CI portability`
- Objects: 9
- Relations: 20
...
- `policy.sf5.validation-hardening` (0.51): Component/recipe changes need validation hardening, working-set coverage and release gate evidence.
